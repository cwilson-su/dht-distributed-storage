...
SKEW_CONFIGS = {
    "centralized": {"csv": "results/centralized_metrics_nodes15.csv", "color": "#4C72B0", "label": "Centralized"},
    "dht":         {"csv": "results/dht_metrics_nodes15.csv",         "color": "#DD8452", "label": "Naive DHT"},
    "chord":       {"csv": "results/chord_metrics_nodes15.csv",       "color": "#55A868", "label": "Chord"},
}
...
if __name__ == "__main__":
    ...
    for idx, (arch, (df, color, label)) in enumerate(datasets.items()):
        ...
        stress_df = df[df["clients"].notnull()]
...
# --- Formatting & Saving (latency, throughput, hops, rebalance) ---
    ...
    # --- Data Skew : graphe séparé basé sur le run à 15 nœuds uniquement ---
    ...
    fig_skew2.savefig(OUTPUT_DIR / "compare_skew.png", dpi=150)
