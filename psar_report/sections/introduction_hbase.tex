...
La figure~\ref{fig:hbase_architecture_simple} donne une vue macro des composants et de leurs interactions. Avant de passer \`a l'analyse d\'etaill\'ee des performances, il est utile d'isoler le cycle d'une requ\^ete d'\'ecriture puis de lecture pour comprendre o\`u se situent le co\^ut de localisation, le chemin de persistance et le point de service de la donn\'ee.
