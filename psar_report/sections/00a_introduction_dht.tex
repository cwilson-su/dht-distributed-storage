...
\begin{figure}[!ht]
	...
	\caption{\textbf{Le probl\`eme du lookup} : le n\oe ud A stocke une donn\'ee \(D\) et le n\oe ud B doit la retrouver sans conna\^itre son emplacement. \texttt{[Source:sch\'ema pris des notes de cours~\cite{DBLP:conf/p2p/WehrleGR05}]}}
...
\begin{figure}[!ht]
	...
	\caption{\textbf{Central Server} : publication, requ\^ete au serveur central, puis t\'el\'echargement direct entre pairs. \texttt{[Source:sch\'ema pris des notes de cours~\cite{DBLP:conf/p2p/WehrleGR05}]}}
...
\begin{figure}[!ht]
	...
	\caption{\textbf{Flooding Search} : diffusion r\'ecursive de requ\^etes, puis retour des n\oe uds ayant la donn\'ee. \texttt{[Source:sch\'ema pris des notes de cours~\cite{DBLP:conf/p2p/WehrleGR05}]}}
...
\begin{figure}[!ht]
	...
	\caption{\textbf{Distributed Hash Table} : routage structur\'e et efficace vers le n\oe ud responsable. \texttt{[Source:sch\'ema pris des notes de cours~\cite{DBLP:conf/p2p/WehrleGR05}]}}
...
\caption{Comparaison de la complexit\'e en termes d'effort de recherche (axe y) et de co\^ut de stockage par n\oe ud (axe x). Les goulots d'\'etranglement (\emph{bottlenecks}) ainsi que les caract\'eristiques sp\'ecifiques de chaque approche sont indiqu\'es. \texttt{[Source:sch\'ema pris des notes de cours~\cite{DBLP:conf/p2p/WehrleGR05}]}}
...
\begin{figure}[!ht]
	...
	\caption{Espace d'adressage lin\'eaire partitionn\'e entre pairs. \texttt{[Source:sch\'ema pris des notes de cours~\cite{DBLP:conf/p2p/WehrleGR05}]}}
...
\begin{figure}[!ht]
	...
	\caption{Vue logique de la DHT et vue du r\'eseau sous-jacent. \texttt{[Source:sch\'ema pris des notes de cours~\cite{DBLP:conf/p2p/WehrleGR05}]} }
...
\begin{figure}[!ht]
	...
	\caption{Comparaison entre stockage direct et stockage indirect. \texttt{[Source:sch\'ema pris des notes de cours~\cite{DBLP:conf/p2p/WehrleGR05}]}}
...
\begin{figure}[h]
	...
	\caption{Interface d'une Distributed Hash Table, typiquement \textsf{put}/\textsf{get}. \texttt{[Source:sch\'ema pris des notes de cours~\cite{DBLP:conf/p2p/WehrleGR05}]}}
